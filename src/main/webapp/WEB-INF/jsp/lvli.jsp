...
<link rel="stylesheet" href="css/lvLi.css" type="text/css"></link>
</head>
<body>
	<div class="geren">
		<div class="geren1">
			...
			<div class="geren2">
				<div class="geren3">
					<span class="userName">137****1903></span> <span class="il8n">,欢迎您!</span>
					<span class="pad3"> <a href=" " class="il8n">招聘首页</a> </span> <em
						class="gg1">|</em> <span class="pad3"> <a href="ApplysServlet"
						class="il8n">个人中心</a> </span> <em class="gg1">|</em> <span class="pad3">
		...
		<div class="geren4">
			<h3 class="zit2">
				<span class="il8n" style="font-weight: bold;">申请职位：</span> <span
					...
					style="font-weight: bold;"> 财务部-高级财务经理/总监(J10804) </strong> </span>
			</h3>
					...
					<tbody>
						<tr>
							<td class="td1" align="center">
								<ul class="diul1">
									<li class="dili1"><a href="#"> <span class="zit4">1基本信息</span>
									</a>
									</li>
									<li class="dili2"></li>
									<li class=" dili3"><a href="#"> <span class="zit5">2个人履历</span>
									</a>
									</li>
									<li class="dili2"></li>
									<li class="dili4"><a href="#"> <span class="zit6">3预览/提交</span>
									</a>
									</li>
								</ul>
							</td>
		...
		<div class="geren7">
			<div class="geren8">
				...
				<br />
				<form action="EducationalServlet?opr=addEducational" method="post"
					id="myform2">
					<div class="zhou">
						<ul>
							<li class="diyi1"><span class="ban">*教育背景</span>
								...
								<div class="ban1">
									<ul>
										<li><label class="yiq">*学校名称：</label> <input type="text"
											class="xue" name="name" /> <span class="zi1">请从大学以来的教育经历开始填写</span>
										</li>

										<li><label class="yiq">*时间:</label> <input type="date"
											class="shij" onclick="WdatePicker()" name="time">
										</li>

										<li><label class="yiq">*专业名称：</label> <input type="text"
											class="chuang" name="ming" />
										</li>

										<li><label class="yiq">*学历:</label> <input type="text"
											class="li1" name="xue" />
										</li>

										<li><label class="yiq">*学位：</label> <select class="wei3"
											name="workname">
					...
					<form action="AddlvliServlet?opr=add" method="post" id="Myform">
						<ul>
							...
							<li><label class="yiq">*工作时间：</label> <input type="date"
								class="shij" name="timeq" onclick="WdatePicker()"></li>
		...
		<div class="ban3">
			<a href="#" class="a1">上一步</a> <input type="button" class="a2"
				value="保存下一步" />
		</div>
