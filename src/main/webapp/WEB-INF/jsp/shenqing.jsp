...
<body>
	<div id="head">
		<img src="img/10772600_medias_logo11.png"
			id="img1" />
		<div id="headnei">
	...
	<div id="lift">
		...
		<ul>
			...
			<li><a href="Jianli.jsp" style="color:black;text-decoration: none;">我的简历</a></li>
			<li><a href="xiugai.jsp" style="color:black;text-decoration: none;">账户设置</a></li>
		</ul>
	</div>
	<div id="zhu" >
		<span><img src="img/2019-08-12_163820.png" /></span>
		<c:choose>
